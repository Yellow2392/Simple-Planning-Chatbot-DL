...
def get_system_prompt(domain: str) -> str:
    if domain == "craves":
        return (
            ...
            "The user prompt ends with '[THOUGHT]'. In max 3 sentences, map the goal letters exactly and check [STEP0 HINTS] to declare your first move.\n"
            ...
            "3. IMMEDIATE PRECONDITION (CRITICAL): The action RIGHT BEFORE '(overcome X Y)' MUST be an attack or feast. NEVER put a '(succumb)' right before an overcome, as it destroys Pain!\n"
